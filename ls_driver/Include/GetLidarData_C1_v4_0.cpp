...
GetLidarData_C1_v4_0::GetLidarData_C1_v4_0()
{
...
void GetLidarData_C1_v4_0::LidarRun()
{
	while (true)
	{
		if (isQuit)
...
void GetLidarData_C1_v4_0::handleSingleEcho(unsigned char* data)
{
...
void GetLidarData_C1_v4_0::handleDoubleEcho(unsigned char* data)
{
	if (data[0] == 0xff && data[1] == 0xee)
	{
...
m_PointXYZ GetLidarData_C1_v4_0::XYZ_calculate(int ID, double H_angle, double Distance)
{
	m_PointXYZ point;
