/** 
* @file coordinante_convert_tool.cpp
* @brief coordinante convert tool source code, convert longitude and latitude to cartesian coordiante, and inverse convert
* @author 
* @version 
* @date 2018/06/07
* @par Copyright (c)
* Shenzhen Yi Cheng Automatic Driving Technology Co., Ltd. www.echiev.com    
**/
